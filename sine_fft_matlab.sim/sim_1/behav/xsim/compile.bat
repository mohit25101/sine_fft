...
REM
REM Generated by Vivado on Mon Jun 01 18:01:08 +0530 2026
...
echo "xvhdl --incr --relax -prj tb_xfft_0_vhdl.prj"
call xvhdl  --incr --relax -prj tb_xfft_0_vhdl.prj -log xvhdl.log
